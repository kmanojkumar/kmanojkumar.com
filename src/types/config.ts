interface SiteMetadata {
  ...
  lang?: string;
  /** IANA timezone for post dates, e.g. "Asia/Kolkata" */
  timezone?: string;
  /** Text direction */
  dir?: "ltr" | "rtl" | "auto";
...
interface ShareLink {
  ...
  /**
   * Accessible label for the icon link (aria-label, title attribute).
   * Auto-generated if omitted: "Share this post on X", "Share this post via WhatsApp", etc.
   * Override when the default wording doesn't fit.
   */
  linkTitle?: string;
}
...
type ResolvedSiteMetadata = Required<
  Pick<
    SiteMetadata,
    | "url"
    | "title"
  ...
  >
> &
  Pick<SiteMetadata, "profile" | "googleVerification">;

export interface ResolvedSiteConfig {
  site: ResolvedSiteMetadata;
